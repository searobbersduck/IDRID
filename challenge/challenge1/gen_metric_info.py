...
root_pred = os.path.join(root_sub, 'pred_ori')
root_gt = os.path.join(root_sub, 'pred_gt')

gt_list = glob(os.path.join(root_gt, '*.png'))
gt_list = [os.path.basename(i).replace('_{}.png'.format(args.cat),'') for i in gt_list]
